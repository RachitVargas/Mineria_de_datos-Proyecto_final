...
Si se usa 'hclust', corrplot() puede dibujar rectángulos alrededor del gráfico de la matriz de correlación en función de los resultados del agrupamiento jerárquico.
...
```
Ninguna de las variables tienen correlación fuerte positiva o negativa. Todas las relaciones son débiles, por lo que las variables no tiene relación directa entre ellas.
